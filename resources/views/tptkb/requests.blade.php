        ...
        <div class="card-body">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-muted">{{ $request->pbphhProfile->user->email }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="fw-bold text-info">
                                                                {{ number_format($request->monthly_volume_m3, 2) }} m³</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="fw-bold">{{ $request->created_at->format('d M Y, H:i') }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <div class="mt-3">
                        <small class="text-muted">Pastikan status kesiapan TPTKB sudah diaktifkan di dashboard</small>
                    </div>
                </div>
            @endif
        </div>
    ...
    @push('scripts')
        <script>
            function respondToRequest(requestId, action) {
                if (action === 'approve') {
                    if (confirm('Apakah Anda yakin ingin menyetujui permintaan ini?')) {
                        ...
                        form.method = 'POST';
                        form.action = '/tptkb/requests/' + requestId + '/respond';
            ...
            function cancelRequest(requestId) {
                if (confirm('Apakah Anda yakin ingin membatalkan permintaan kerjasama ini? Tindakan ini tidak dapat dibatalkan.')) {
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = '/tptkb/requests/' + requestId + '/cancel';
            ...
            `;
                ...
                fetch(`/tptkb/company-profile/${pbphhId}`)
