...
@section('title', 'Dashboard TPTKB - JASA KAYA')

@section('dashboard-content')
<!-- Header -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold text-primary mb-1">Dashboard TPTKB</h2>
        <p class="text-muted mb-0">Selamat datang, {{ $tptkb->tptkb_name }}</p>
    </div>
    <div class="text-end">
    ...
    <div class="col-12">
        <div class="card border-primary">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">
                    <i class="fas fa-check-circle me-2"></i>Status Kesiapan TPTKB
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-4">
                        ...
                        <div class="status-card">
                            <div class="status-header">
                                ...
                                <div class="status-info">
                                    ...
                                    <p class="status-desc mb-0">Menandakan TPTKB siap menjalin kemitraan dengan industri</p>
                                </div>
                            </div>
                            <div class="status-toggle">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="siapMitra" 
                                           {{ $tptkb->is_siap_mitra ? 'checked' : '' }}
                                           onchange="updateStatus('is_siap_mitra', this.checked)">
                                    <label class="form-check-label" for="siapMitra">
                                        <span class="switch-text">{{ $tptkb->is_siap_mitra ? 'Aktif' : 'Nonaktif' }}</span>
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-lg-8 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('tptkb.requests') }}" class="btn btn-sm btn-outline-primary">
                    Lihat Semua
                </a>
            </div>
            <div class="card-body">
...
const tptkbData = {
    nama_pendamping_tptkb: @json($tptkb->nama_pendamping_tptkb ?? ''),
    alamat_tptkb: @json($tptkb->alamat_tptkb ?? ''),
    coordinate_lat: @json($tptkb->coordinate_lat ?? null),
    coordinate_lng: @json($tptkb->coordinate_lng ?? null),
};
