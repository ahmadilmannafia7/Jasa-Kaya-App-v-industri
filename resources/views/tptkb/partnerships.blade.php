        ...
        <div class="card-body">
                            ...
                            <div class="card partnership-card mb-4 shadow-sm">
                                <div class="card-body p-4">
                                    <div class="partnership-status">
                                        ...
                                        @else
                                            <span class="badge bg-light text-dark border"><i
                                                    class="fas fa-clock me-1"></i>{{ ucfirst($partnership->status) }}</span>
                                        @endif
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="fas fa-envelope me-1"></i>{{ $partnership->pbphhProfile->user->email }}
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="info-card p-3 bg-light rounded">
                                                <div class="d-flex align-items-center">
                                                    <div class="icon-wrapper bg-light text-dark rounded-circle me-3 border"
                                            ...
                                            <div class="info-card p-3 bg-light rounded">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            class="fw-bold text-dark">{{ number_format($partnership->monthly_volume_m3, 2) }}
                                                            m³</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <div class="meeting-detail-card p-3 border rounded text-center">
                                                        <div class="icon-wrapper bg-light text-dark rounded-circle mx-auto mb-2 border"
                                                            style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center;">
                                                            <i class="fas fa-calendar"></i>
                                                        </div>
                                                        <small class="text-muted d-block mb-1">Tanggal</small>
                                                        <span
                                                            class="fw-bold text-dark">{{ ($partnership->pertemuan->scheduled_time && is_object($partnership->pertemuan->scheduled_time)) ? $partnership->pertemuan->scheduled_time->format('d M Y') : '-' }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="meeting-detail-card p-3 border rounded text-center">
                                                        ...
                                                        <span
                                                            class="fw-bold text-dark">{{ ($partnership->pertemuan->scheduled_time && is_object($partnership->pertemuan->scheduled_time)) ? $partnership->pertemuan->scheduled_time->format('H:i') : '-' }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="meeting-detail-card p-3 border rounded text-center">
                                        ...
                                        @if($partnership->pertemuan->kesepakatan)
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="fw-bold text-dark fs-6">Rp
                                                                        {{ number_format($partnership->pertemuan->kesepakatan->agreed_price_per_m3, 0, ',', '.') }}/m³</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="agreement-card p-3 border rounded bg-light">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span
                                                                        class="fw-bold text-dark">{{ $partnership->pertemuan->kesepakatan->payment_mechanism }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="agreement-card p-3 border rounded bg-light">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span
                                                                        class="fw-bold text-dark">{{ $partnership->pertemuan->kesepakatan->delivery_schedule }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="alert alert-info mb-0">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div>
                                                                ...
                                                                <span
                                                                    class="small">{{ $partnership->pertemuan->kesepakatan->other_notes }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endif

                                                @if($partnership->pertemuan->kesepakatan->final_document_path)
                                                    <div class="mt-3">
                                                        <a href="{{ Storage::url($partnership->pertemuan->kesepakatan->final_document_path) }}"
                                                            target="_blank" class="btn btn-sm btn-outline-primary">
                                                            <i class="fas fa-file-download me-2"></i>Unduh Dokumen Kerjasama
                                                        </a>
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="signature-section mt-4 pt-4 border-top">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <div
                                                            class="signature-card p-3 border rounded {{ $partnership->pertemuan->kesepakatan->signed_by_tptkb_at ? 'border-light bg-light' : 'border-light bg-light' }}">
                                                            <div class="d-flex align-items-center">
                                                                @if($partnership->pertemuan->kesepakatan->signed_by_tptkb_at)
                                                                    <div class="icon-wrapper bg-light text-dark rounded-circle me-3 border"
                                                                        style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center;">
                                                                        <i class="fas fa-check-circle"></i>
                                                                    </div>
                                                                    <div>
                                                                        <small class="text-muted d-block mb-1">TPTKB</small>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div
                                                            class="signature-card p-3 border rounded {{ $partnership->pertemuan->kesepakatan->signed_by_pbphh_at ? 'border-light bg-light' : 'border-light bg-light' }}">
                                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mt-4">
                                                    @if(!$partnership->pertemuan->kesepakatan->signed_by_tptkb_at)
                                                        <div class="text-center">
                                                            <button class="btn btn-primary btn-lg px-4 py-2 shadow-sm"
                                                                onclick="signAgreement('{{ $partnership->request_id }}')">
                                                    ...
                                                    @elseif($partnership->pertemuan->kesepakatan->signed_by_tptkb_at && $partnership->pertemuan->kesepakatan->signed_by_pbphh_at)
                                                        <div class="alert alert-light border shadow-sm mb-0">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <small class="mb-0">Ditandatangani pada
                                                                        {{ ($partnership->pertemuan->kesepakatan->signed_by_tptkb_at && is_object($partnership->pertemuan->kesepakatan->signed_by_tptkb_at)) ? $partnership->pertemuan->kesepakatan->signed_by_tptkb_at->format('d M Y, H:i') : '-' }}</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="alert alert-light border shadow-sm mb-0">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <small class="mb-0">Anda telah menandatangani pada
                                                                        {{ ($partnership->pertemuan->kesepakatan->signed_by_tptkb_at && is_object($partnership->pertemuan->kesepakatan->signed_by_tptkb_at)) ? $partnership->pertemuan->kesepakatan->signed_by_tptkb_at->format('d M Y, H:i') : '-' }}</small>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('tptkb.requests') }}" class="btn btn-primary">
        ...
        <script>
            function signAgreement(requestId) {
                if (confirm('Apakah Anda yakin ingin menandatangani kesepakatan ini? Tindakan ini tidak dapat dibatalkan.')) {
                    ...
                    form.method = 'POST';
                    form.action = '/tptkb/partnerships/' + requestId + '/sign';
