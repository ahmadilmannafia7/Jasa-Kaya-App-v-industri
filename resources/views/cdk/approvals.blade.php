                                    ...
                                    <td>
                                        @if($user->kthr && $user->kthr->ketua_ktp_path && $user->kthr->sk_register_path)
                                            <div class="btn-group-vertical btn-group-sm">
                                                <a href="{{ Storage::url($user->kthr->ketua_ktp_path) }}" target="_blank"
                                                    class="btn btn-outline-primary btn-sm">
                                                    <i class="fas fa-id-card me-1"></i>KTP KTHR
                                                </a>
                                                <a href="{{ Storage::url($user->kthr->sk_register_path) }}" target="_blank"
                                                    class="btn btn-outline-secondary btn-sm">
                                                    <i class="fas fa-file-alt me-1"></i>SK KTHR
                                                </a>
                                            </div>
                                        @elseif($user->tptkb && $user->tptkb->ketua_ktp_path && $user->tptkb->sk_tptkb_path)
                                            <div class="btn-group-vertical btn-group-sm">
                                                <a href="{{ Storage::url($user->tptkb->ketua_ktp_path) }}" target="_blank"
                                                    class="btn btn-outline-primary btn-sm">
                                                    <i class="fas fa-id-card me-1"></i>KTP TPTKB
                                                </a>
                                                <a href="{{ Storage::url($user->tptkb->sk_tptkb_path) }}" target="_blank"
                                                    class="btn btn-outline-secondary btn-sm">
                                                    <i class="fas fa-file-alt me-1"></i>SK TPTKB
                                                </a>
                                            </div>
                                        @else
