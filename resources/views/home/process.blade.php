...
@section('content')
                ...
                <div class="col-lg-4 mb-4" data-aos="fade-up">
                    <div class="card border-warning h-100">
                        <div class="card-header bg-warning text-white">
                            <h4 class="mb-0">
                                <i class="fas fa-warehouse me-2"></i>Proses untuk TPTKB
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="timeline">
                                ...
                                <div class="timeline-item mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="fw-bold">Menunggu Verifikasi CDK</h6>
                                        <p class="small text-muted mb-1">
                                            CDK memverifikasi dokumen dan data TPTKB
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="fw-bold">Lengkapi Profil</h6>
                                        <p class="small text-muted mb-1">
                                            Isi data TPTKB dan stok/jenis kayu yang tersedia
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item mb-3">
                                    <div class="timeline-marker bg-primary"></div>
                                    <div class="timeline-content">
                                        <h6 class="fw-bold">Terima Permintaan/Ajukan Kemitraan</h6>
                                        <p class="small text-muted mb-1">
                                            Eksplorasi KTHR dan ajukan kemitraan atau
                                            terima permintaan PBPHH
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="fw-bold">Tanda Tangan Kontrak</h6>
                                        <p class="small text-muted mb-1">
                                            Menandatangani perjanjian setelah fasilitasi CDK
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="timeline">
                                ...
                                <div class="timeline-item mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="fw-bold">Terima Permintaan/Ajukan Kemitraan</h6>
                                        <p class="small text-muted mb-1">Eksplorasi KTHR/TPTKB/PBPHH dan ajukan
                                            kemitraan/terima permintaan</p>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    <div class="timeline-marker bg-success"></div>
                    ...
                    <div class="card border-success h-100">
                        <div class="card-header bg-light">
                            <h5 class="mb-0 text-success">
                                <i class="fas fa-tree me-2"></i>KTHR/Penyuluh
                            </h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-muted">Format: PDF, JPG, PNG (Max. 2 MB)</div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    <i class="fas fa-check-circle text-success me-3"></i>
                                    <div>
                                        <strong>SK Registrasi KTHR</strong>
                                        <div class="small text-muted">Format: PDF (Max. 2 MB)</div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-muted">Digunakan untuk notifikasi sistem</div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card border-warning h-100">
                        <div class="card-header bg-light">
                            <h5 class="mb-0 text-warning">
                                <i class="fas fa-warehouse me-2"></i>TPTKB
                            </h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    ...
                                    <div>
                                        <strong>Email Aktif</strong>
                                        <div class="small text-muted">Digunakan untuk komunikasi dan notifikasi</div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="video-frame-wrapper">
                                        <div class="ratio ratio-16x9">
                                            <iframe id="tutorialVideo"
                                                ...
                                                title="Cara Pendaftaran JASA KAYA" frameborder="0"
                                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                                allowfullscreen class="video-iframe-enhanced" onload="hideVideoLoading()">
                                            </iframe>
                                        </div>
                                    </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        <div class="accordion-item" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Proses verifikasi untuk KTHR memakan waktu 1-3 hari kerja oleh CDK, sedangkan untuk
                                    industri PBPHH memakan waktu 3-5 hari kerja oleh Dinas Provinsi.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Platform JASA KAYA sepenuhnya gratis untuk digunakan. Tidak ada biaya pendaftaran,
                                    verifikasi, atau penggunaan fitur-fitur yang tersedia.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Jika dokumen ditolak, Anda akan menerima notifikasi dengan alasan penolakan yang jelas.
                                    Anda dapat memperbaiki dokumen dan mendaftar ulang.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-5 bg-primary text-white">
        <div class="container text-center">
            ...
            <p class="lead mb-4">Bergabunglah dengan ribuan KTHR dan industri yang telah merasakan manfaat kemitraan
                berkelanjutan</p>
