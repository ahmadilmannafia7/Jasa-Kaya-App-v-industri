...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('permintaan_kerjasama', function (Blueprint $table) {
            $table->id('request_id');
            $table->foreignId('pbphh_id')->constrained('pbphh_profiles', 'pbphh_id')->onDelete('cascade')->nullable();
            $table->foreignId('kthr_id')->constrained('kthrs', 'kthr_id')->onDelete('cascade')->nullable();
